...
import { topMessage } from "@/data";

export default function DaysTogether({ animationDuration = 3 }) {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        {/* <div
          className="absolute top-1/4 right-10 text-3xl animate-float"
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <motion.div
            ...
            className="text-2xl md:text-3xl text-pink-500 font-medium mb-8 text-center"
          >
            Magical Years of Your Journey
          </motion.div>
