...
export default function Message({ message }) {
    ...
    return (
        ...
        >
            ...
            <motion.div
                className="absolute -bottom-12 right-30 md:-bottom-12 md:-right-40 text-5xl md:text-6xl"
                animate={{
                    y: [0, -15, 0],
                    rotate: [0, -10, 0],
                }}
            ...
            >
                ...
                <div className="relative z-10 text-gray-700 leading-relaxed">
                    {lines.map((line, index) => (
                        <motion.p
                            ...
                            className={`${line.trim() === "" ? "h-4" : ""} ${index === 0 && "text-xl font-medium text-pink-600 mb-2"} ${index === lines.length-1 && "text-xl font-medium text-pink-600 mt-2"} `}
                        >
                            {line}
                        </motion.p>
                    ))}
